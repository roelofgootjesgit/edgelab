...
KST (Know Sure Thing) - TODO: Add description
...
class KstModule(BaseModule):
    """
    KST (Know Sure Thing) module.
    ...
    def calculate(self, data: pd.DataFrame, config: Dict) -> pd.DataFrame:
        """
        TODO: Calculate KST (Know Sure Thing)
