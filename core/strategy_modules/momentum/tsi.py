...
TSI (True Strength Index) - TODO: Add description
...
class TsiModule(BaseModule):
    """
    TSI (True Strength Index) module.
    ...
    @property
    def name(self) -> str:
        return "TSI (True Strength Index)"
    ...
    def calculate(self, data: pd.DataFrame, config: Dict) -> pd.DataFrame:
        """
        TODO: Calculate TSI (True Strength Index)
